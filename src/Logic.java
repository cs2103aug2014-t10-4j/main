...
/**
 * This program handles the logic for the DoubleUp
 * 
 * This implementation uses an arrayList<Task> as the date structure and is able
 * to perform add,delete,edit,search,clear, sort undo and redo functionalities.
 *
 */
public class Logic {
